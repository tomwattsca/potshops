...
export const priorityCategories: Category[] = [
  { slug: 'dispensary', legacyPath: '/category/dispensary/', title: 'Canadian cannabis dispensary directory', description: 'Browse Canadian cannabis dispensary profiles and city pages with public-source notes. Potshops.ca separates listing evidence from unverified current-store claims.', gscEvidence: 'This hub keeps dispensary searches pointed at profiles with source notes, mapped city pages, and clear notes about what Potshops can and cannot verify.', legacyImpressions: 55, priority: 1 },
  { slug: 'in-town-delivery', legacyPath: '/category/in-town-delivery/', title: 'Cannabis delivery listings in Canada', description: 'Browse Canadian cannabis delivery-related profiles only where Potshops has public-source context. The page does not claim delivery is available today, ordering, menus, or licences.', gscEvidence: 'This hub keeps delivery-intent searches tied to public-source profiles and city pages while avoiding unsupported current-delivery claims.', legacyImpressions: 113, priority: 2 },
];
